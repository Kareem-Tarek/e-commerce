...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="card-header" style="text-align: center; width: 79%; padding:0.25%; background-color:rgb(33, 33, 33); color:snow; border-radius:10px; margin-bottom:3%; margin-top:8%; margin-left:auto; margin-right:auto;">
            <h1>FAQ's</h1>
        </div>
